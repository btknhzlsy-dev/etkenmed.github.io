...
},
{
    ...
    dozajlar: {
        yetiskin: `
            ...
            <h6 class="dose-type-title">Hemen Salınım (IR)</h6>
            <ul class="dose-details-list">
                <li><strong>Başlangıç:</strong> 80 mg (PO) q8hr.</li>
                <li><strong>Olağan Aralık:</strong> 80-120 mg (PO) q8hr. (Max 480 mg/gün).</li>
            </ul>
            <h6 class="dose-type-title">Uzatılmış Salınım (ER)</h6>
            <ul class="dose-details-list">
                <li><strong>Başlangıç:</strong> 180 mg/gün (PO) yatarken (Covera-HS) VEYA sabahları (Calan SR).</li>
                <li><strong>İdame:</strong> 180-540 mg/gün (PO).</li>
            </ul>

            <h5 class="dose-condition-title">Hipertansiyon</h5>
            <h6 class="dose-type-title">IR</h6>
            <ul class="dose-details-list">
                <li><strong>Başlangıç:</strong> 80 mg (PO) q8hr.</li>
                <li><strong>İdame:</strong> 80-320 mg (PO) q12hr.</li>
            </ul>
            <h6 class="dose-type-title">ER (Calan/Isoptin SR, Verelan, Covera-HS)</h6>
            <ul class="dose-details-list">
                <li><strong>Başlangıç:</strong> 180 mg/gün (PO) (Yaşlı veya küçük yapılı hastada **120 mg/gün**).</li>
                <li><strong>Titrasyon:</strong> İstenen yanıta göre artırılır (Max 480 mg/gün).</li>
            </ul>

            <h5 class="dose-condition-title">Supraventriküler Aritmi & Atriyal Fibrilasyon/Flutter (Akut)</h5>
            <h6 class="dose-type-title">IV Uygulama</h6>
            <ul class="dose-details-list">
                <li><strong>İlk Doz:</strong> 2.5-5 mg (IV) (2 dakika üzerinde).</li>
                <li><strong>Tekrar:</strong> 15-30 dakika sonra 5-10 mg doz tekrarlanabilir. VEYA</li>
                <li><strong>Kilo Bazlı:</strong> 0.075-0.15 mg/kg (Max 10 mg) IV (2 dakika üzerinde); 30 dakika sonra bir kez tekrarlanabilir.</li>
            </ul>
            
            <h5 class="dose-condition-title">Dozaj Modifikasyonları</h5>
            <ul class="dose-details-list simple-list">
                <li><strong>Karaciğer Yetmezliği (Siroz):</strong> Oral ve IV dozlar normal dozun **%20-50'si** kadar azaltılmalıdır.</li>
                <li><strong>Böbrek Yetmezliği:</strong> Dikkatli kullanılmalı; EKG izlenmeli. (CrCl <10 mL/dk ise doz **%25-50** azaltılır).</li>
            </ul>
        `,
        cocuk: `
            <h5 class="dose-condition-title">Supraventriküler Taşikardi (SVT)</h5>
            <h6 class="dose-type-title">1-15 Yaş (IV)</h6>
            <ul class="dose-details-list">
                <li><strong>İlk Doz:</strong> 0.1-0.3 mg/kg (Max 5 mg) IV (2 dakika üzerinde).</li>
                <li><strong>Tekrar:</strong> İkinci doz (Max 10 mg) 30 dakika sonra verilebilir.</li>
            </ul>
            <h6 class="dose-type-title">Oral (Endikasyon Dışı)</h6>
            <ul class="dose-details-list">
                <li><strong>Doz:</strong> 4-8 mg/kg/gün (PO) q8hr bölünmüş.</li>
            </ul>
        `,
        yasli: `
            <h5 class="dose-condition-title">Geriatrik Doz</h5>
            <ul class="dose-details-list simple-list">
                <li>Hipotansiyon ve bradikardi riski nedeniyle daha düşük başlangıç dozları önerilir (Örn. IR Hipertansiyon için **40 mg PO q8hr**).</li>
                <li>ER formlarının başlangıç dozu (Verelan, Calan SR, Covera-HS) yaşlı veya küçük yapılı hastada **120 mg/gün** ile başlanmalıdır.</li>
            </ul>
        `
    }
},
